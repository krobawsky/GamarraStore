...
import tecsup.integrador.loginandroid.activity.ProductoRegisterActivity;
import tecsup.integrador.loginandroid.adapter.ProductosAdapter;
...
public class ProductoFragment extends Fragment {
    ...
    private static final String TAG = ProductoFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RegisterTienda.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent i = new Intent(getActivity(), ProductoRegisterActivity.class);
                startActivity(i);
            }
        });
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener) {
            ...
            Toast.makeText(context, "Producto Fragment", Toast.LENGTH_SHORT).show();
        }
    }
